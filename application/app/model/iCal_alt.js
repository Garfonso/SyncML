var iCal = function(){
  ...
  //TODO: problem:  <> is allowed here, as it seems... this confuses xmlParser of JS. => item.data is broken => event is broken... :(
  //Is this an egroupware bug? Or is it really this way? Don't want to fix the xmlParser... 
    ...
    return {
         ...
         * But we are splitting this string apart. So we need to rebuild it...
